...
(0,react.useEffect)(function(){setTreeData(data);},[data]);/**
   ...
   */var addNode=function addNode(rowInfo){var NEW_NODE={key:"test",value:"test",title:"test的中文",label:"test的中文"};/**
