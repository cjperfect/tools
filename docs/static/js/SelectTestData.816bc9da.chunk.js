...
var SelectTestData=function SelectTestData(props){var _useState=(0,react.useState)(""),_useState2=(0,slicedToArray/* default */.Z)(_useState,2),code=_useState2[0],setCode=_useState2[1];// 生成的代码
var _useState3=(0,react.useState)([]),_useState4=(0,slicedToArray/* default */.Z)(_useState3,2),treeData=_useState4[0],setTreeData=_useState4[1];var _useState5=(0,react.useState)(false),_useState6=(0,slicedToArray/* default */.Z)(_useState5,2),visible=_useState6[0],setVisible=_useState6[1];// 导入配置
/**
   * 导入配置弹窗关闭
