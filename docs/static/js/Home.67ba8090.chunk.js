...
/* harmony export */ });
/* 存放一些常量 */var REQUIRED_RULES=[{required:true,message:"请输入"}];var CONFIG_EXAMPLE=[{dataIndex:"name",title:"姓名",ellipsis:true,width:150,align:"left",randomType:"cname"},{dataIndex:"date",title:"日期",ellipsis:true,width:150,align:"left",randomType:"date"}];/**
 * 默认添加的字段信息
 */var DEFAULT_ADD_FIELD={dataIndex:"fundCode",title:"产品名称",width:150,fixed:false,align:"left",ellipsis:true,className:undefined,randomType:"ctitle"};/* 随机类型 */var RANDOM_TYPE_ARR=[{key:"ctitle",value:"ctitle",label:"标题"},{key:"natural",value:"natural",label:"整数"},{key:"float",value:"float",label:"浮点数（两位小数）"},{key:"cname",value:"cname",label:"名字"},{key:"date",value:"date",label:"日期"},{key:"time",value:"time",label:"时间"},{key:"datetime",value:"datetime",label:"日期时间"},{key:"cparagraph",value:"cparagraph",label:"长文本"},{key:"sex",value:"sex",label:"性别"},{value:"province",label:"城市"}];
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(47313);
/* harmony import */ var antd__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(17786);
/* harmony import */ var antd__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(98740);
...
/* harmony import */ var utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(21114);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(46417);
/* 导入配置，模态框 */var TextArea=antd__WEBPACK_IMPORTED_MODULE_4__/* ["default"].TextArea */ .Z.TextArea;var ImportConfigModal=function ImportConfigModal(props){var visible=props.visible,onSubmit=props.onSubmit,onCancel=props.onCancel,footer=props.footer;var _Form$useForm=antd__WEBPACK_IMPORTED_MODULE_5__/* ["default"].useForm */ .Z.useForm(),_Form$useForm2=(0,C_Users_Administrator_Desktop_study_generate_columns_node_modules_babel_runtime_helpers_esm_slicedToArray_js__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .Z)(_Form$useForm,1),form=_Form$useForm2[0];var onFinish=function onFinish(values){try{// eslint-disable-next-line
var columns=eval(values.content).map(function(v){return (0,C_Users_Administrator_Desktop_study_generate_columns_node_modules_babel_runtime_helpers_esm_objectSpread2_js__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .Z)((0,C_Users_Administrator_Desktop_study_generate_columns_node_modules_babel_runtime_helpers_esm_objectSpread2_js__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .Z)({},v),{},{align:v.align||"left"});});(0,utils__WEBPACK_IMPORTED_MODULE_2__/* .saveConfigToStorage */ .e)(JSON.stringify(columns,null,2));onSubmit===null||onSubmit===void 0?void 0:onSubmit(columns);}catch(e){return antd__WEBPACK_IMPORTED_MODULE_8__/* ["default"].error */ .ZP.error("配置格式有误，请检查");}};return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)(antd__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .Z,{title:"\u5BFC\u5165\u914D\u7F6E",open:visible,onCancel:onCancel,footer:footer||null,children:/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsxs)(antd__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z,{form:form,onFinish:onFinish,layout:"vertical",children:[/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)(antd__WEBPACK_IMPORTED_MODULE_5__/* ["default"].Item */ .Z.Item,{name:"content",label:/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.Fragment,{children:["\u8BF7\u8F93\u5165\u914D\u7F6E\uFF1A",/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)(antd__WEBPACK_IMPORTED_MODULE_10__/* ["default"] */ .Z,{size:"middle",children:/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)(antd__WEBPACK_IMPORTED_MODULE_11__/* ["default"] */ .Z,{onClick:function onClick(){form.setFieldValue("content",JSON.stringify(config_constant__WEBPACK_IMPORTED_MODULE_1__/* .CONFIG_EXAMPLE */ .UE,null,2));},children:"\u5BFC\u5165\u793A\u4F8B"})})]}),rules:config_constant__WEBPACK_IMPORTED_MODULE_1__/* .REQUIRED_RULES */ .f4,children:/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)(TextArea,{placeholder:"\u8BF7\u8F93\u5165\u914D\u7F6E",autoSize:{minRows:15,maxRows:15}})}),/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)(antd__WEBPACK_IMPORTED_MODULE_5__/* ["default"].Item */ .Z.Item,{children:/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsxs)(antd__WEBPACK_IMPORTED_MODULE_10__/* ["default"] */ .Z,{size:"large",children:[/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)(antd__WEBPACK_IMPORTED_MODULE_11__/* ["default"] */ .Z,{type:"primary",htmlType:"submit",style:{width:120},children:"\u5BFC\u5165"}),/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)(antd__WEBPACK_IMPORTED_MODULE_11__/* ["default"] */ .Z,{htmlType:"reset",children:"\u91CD\u7F6E"})]})})]})});};/* harmony default export */ __webpack_exports__["Z"] = (ImportConfigModal);
...
/* harmony import */ var C_Users_Administrator_Desktop_study_generate_columns_node_modules_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(93433);
/* harmony import */ var C_Users_Administrator_Desktop_study_generate_columns_node_modules_babel_runtime_helpers_esm_slicedToArray_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(29439);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(47313);
/* harmony import */ var antd__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(17786);
/* harmony import */ var antd__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(97258);
/* harmony import */ var antd__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(45705);
/* harmony import */ var antd__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(59491);
/* harmony import */ var antd__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(94401);
/* harmony import */ var antd__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(98276);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(46417);
/* 查看已导入配置的抽屉 */var TextArea=antd__WEBPACK_IMPORTED_MODULE_2__/* ["default"].TextArea */ .Z.TextArea;var ConfigDrawer=function ConfigDrawer(props){var visible=props.visible,onClose=props.onClose,setContent=props.setContent;var _useState=(0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([]),_useState2=(0,C_Users_Administrator_Desktop_study_generate_columns_node_modules_babel_runtime_helpers_esm_slicedToArray_js__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z)(_useState,2),configListState=_useState2[0],setConfigListState=_useState2[1];(0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function(){if(visible){setConfigListState(JSON.parse(localStorage.myConfig||"[]").reverse());}// eslint-disable-next-line
},[visible]);return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(antd__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z,{title:"\u67E5\u770B\u5DF2\u5BFC\u5165\u7684\u914D\u7F6E",placement:"right",open:visible,size:"large",onClose:onClose,children:configListState!==null&&configListState!==void 0&&configListState.length?/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("div",{className:"config-list",children:configListState.map(function(v){var config=v.config,id=v.id;return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)("div",{className:"config",style:{marginBottom:20},children:[/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)(antd__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z,{style:{marginBottom:10},children:[/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(antd__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .Z,{danger:true,onClick:function onClick(){antd__WEBPACK_IMPORTED_MODULE_7__/* ["default"].confirm */ .Z.confirm({content:"确定要删除吗？",okText:"确认",cancelText:"取消",onOk:function onOk(){var data=(0,C_Users_Administrator_Desktop_study_generate_columns_node_modules_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_8__/* ["default"] */ .Z)(configListState);var restData=data.filter(function(v){return v.id!==id;});localStorage.myConfig=JSON.stringify(restData);setConfigListState(restData);}});},children:"\u5220\u9664"}),/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(antd__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .Z,{onClick:function onClick(){setContent(config);onClose();},children:"\u9009\u62E9"})]}),/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(TextArea,{placeholder:"\u8BF7\u8F93\u5165\u914D\u7F6E",autoSize:{minRows:10,maxRows:10},value:config})]},id);})}):/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(antd__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .Z,{description:"\u6682\u65E0\u6570\u636E"})},"right");};/* harmony default export */ __webpack_exports__["Z"] = (ConfigDrawer);
...
var es_form = __webpack_require__(98740);
...
var es_radio = __webpack_require__(62214);
// EXTERNAL MODULE: ./node_modules/antd/es/select/index.js + 48 modules
var es_select = __webpack_require__(71890);
...
/* harmony import */ var antd__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(87408);
...
/* harmony export */   "e": function() { return /* binding */ saveConfigToStorage; }
/* harmony export */ });
/* harmony import */ var C_Users_Administrator_Desktop_study_generate_columns_node_modules_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(93433);
...
temp[dataIndex]=random.pick(["男","女"]);}else if(randomType==="float"){// 两位小数的浮点数
temp[dataIndex]=random[randomType](0,100,2,2);}else{temp[dataIndex]=random[randomType]();}});data.push(temp);};for(var i=1;i<=num;i++){_loop(i);}return{data:data,columns:columns,dataText:"const dataSource = ".concat(JSON.stringify(data,null,2)),columnsText:"const ".concat(variable," = ").concat(JSON.stringify(newColumns,null,2))};};// 保存配置到localstorage
var saveConfigToStorage=function saveConfigToStorage(val){var data=[];var obj={id:mockjs__WEBPACK_IMPORTED_MODULE_0___default().Random.id(),config:val};if(!localStorage.myConfig){data=[obj];}else{data=[].concat((0,C_Users_Administrator_Desktop_study_generate_columns_node_modules_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z)(JSON.parse(localStorage.myConfig)),[obj]);}localStorage.myConfig=JSON.stringify(data);};
