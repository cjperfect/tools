...
/* harmony export */   "zR": function() { return /* binding */ SELECT_DATA_TEMPLATE; }
/* harmony export */ });
/* unused harmony export DEFAULT_SELECT_TEST_DATA */
...
var tabs = __webpack_require__(64393);
...
var UpOutlined = __webpack_require__(69356);
// EXTERNAL MODULE: ./node_modules/@ant-design/icons/es/icons/DownOutlined.js
var DownOutlined = __webpack_require__(32344);
...
/* 导入配置，模态框 */var ImportConfigModal_TextArea=input/* default.TextArea */.Z.TextArea;// 保存配置到localstorage
...
var DraggableTree=function DraggableTree(props){var data=props.data,_onChange=props.onChange;var _useState=(0,react.useState)([]),_useState2=(0,slicedToArray/* default */.Z)(_useState,2),treeData=_useState2[0],setTreeData=_useState2[1];(0,react.useEffect)(function(){setTreeData(data);},[data]);/**
   * 添加子节点
   * @param rowInfo 当前节点信息
   */var addNode=function addNode(rowInfo){var NEW_NODE={key:"test",value:"test",title:"test的中文",label:"test的中文"};var newTree=(0,index_esm/* addNodeUnderParent */.YI)({treeData:treeData,newNode:NEW_NODE,expandParent:true,parentKey:rowInfo?rowInfo.treeIndex:undefined,getNodeKey:function getNodeKey(_ref){var treeIndex=_ref.treeIndex;return treeIndex;}});_onChange(newTree.treeData);setTreeData(newTree.treeData);};/**
   * 删除当前节点
   * @param rowInfo 当前节点信息
   */var removeNode=function removeNode(rowInfo){var path=rowInfo.path;var newTree=(0,index_esm/* removeNodeAtPath */.k)({treeData:treeData,path:path,getNodeKey:function getNodeKey(_ref2){var treeIndex=_ref2.treeIndex;return treeIndex;}});_onChange(newTree);setTreeData(newTree);};/**
   * 添加顶层节点
   */var addTopNode=function addTopNode(){var data=[].concat((0,toConsumableArray/* default */.Z)(treeData),[{key:"test",value:"test",title:"test的中文",label:"test的中文"}]);_onChange(data);setTreeData(data);};return/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:"draggable-tree-com",children:[/*#__PURE__*/(0,jsx_runtime.jsx)(es_button/* default */.Z,{onClick:addTopNode,children:"\u6DFB\u52A0\u8282\u70B9"}),/*#__PURE__*/(0,jsx_runtime.jsx)(index_esm/* default */.ZP,{isVirtualized:false,treeData:treeData,onChange:function onChange(data){setTreeData(data);_onChange(data);},generateNodeProps:function generateNodeProps(rowInfo){var node=rowInfo.node;return{title:/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:"field-wrap",children:[/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:"field-line",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("span",{children:"\u503C\uFF1A"}),/*#__PURE__*/(0,jsx_runtime.jsx)(input/* default */.Z,{placeholder:"\u8BF7\u8F93\u5165\u503C",defaultValue:node.value,onChange:function onChange(e){var val=e.target.value.trim();node.value=node.key=val;}})]}),/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:"field-line",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("span",{children:"\u4E2D\u6587\uFF1A"}),/*#__PURE__*/(0,jsx_runtime.jsx)(input/* default */.Z,{placeholder:"\u8BF7\u8F93\u5165\u503C\u5BF9\u5E94\u7684\u4E2D\u6587",defaultValue:node.title,onChange:function onChange(e){var val=e.target.value.trim();node.title=node.label=val;}})]})]},node.value+node.title),buttons:[/*#__PURE__*/(0,jsx_runtime.jsx)(PlusCircleOutlined/* default */.Z,{onClick:function onClick(){addNode(rowInfo);}}),/*#__PURE__*/(0,jsx_runtime.jsx)(MinusCircleOutlined/* default */.Z,{onClick:function onClick(){removeNode(rowInfo);}})]};}})]});};/* harmony default export */ var components_DraggableTree = (DraggableTree);
// EXTERNAL MODULE: ./node_modules/antd/es/form/index.js + 22 modules
var es_form = __webpack_require__(82465);
// EXTERNAL MODULE: ./node_modules/antd/es/modal/index.js + 17 modules
var modal = __webpack_require__(94401);
...
// EXTERNAL MODULE: ./src/config/constant.ts
var constant = __webpack_require__(54246);
;// CONCATENATED MODULE: ./src/page/SelectTestData/components/ImportConfigModal/index.tsx
/* 导入配置，模态框 */var TextArea=input/* default.TextArea */.Z.TextArea;var ImportConfigModal=function ImportConfigModal(props){var visible=props.visible,onSubmit=props.onSubmit,onCancel=props.onCancel,footer=props.footer;var _Form$useForm=es_form/* default.useForm */.Z.useForm(),_Form$useForm2=(0,slicedToArray/* default */.Z)(_Form$useForm,1),form=_Form$useForm2[0];var onFinish=function onFinish(values){try{var data=JSON.parse(values.content);onSubmit(data);}catch(e){return message/* default.error */.ZP.error("配置格式有误，请检查");}};return/*#__PURE__*/(0,jsx_runtime.jsx)(modal/* default */.Z,{title:"\u6279\u91CF\u6DFB\u52A0\u914D\u7F6E",open:visible,onCancel:onCancel,footer:footer||null,children:/*#__PURE__*/(0,jsx_runtime.jsxs)(es_form/* default */.Z,{form:form,onFinish:onFinish,layout:"vertical",children:[/*#__PURE__*/(0,jsx_runtime.jsx)(es_form/* default.Item */.Z.Item,{name:"content",label:/*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:["\u8BF7\u8F93\u5165\u914D\u7F6E\uFF1A",/*#__PURE__*/(0,jsx_runtime.jsx)(space/* default */.Z,{size:"middle",children:/*#__PURE__*/(0,jsx_runtime.jsx)(es_button/* default */.Z,{onClick:function onClick(){form.setFieldValue("content",constant/* SELECT_DATA_TEMPLATE */.zR);},children:"\u793A\u4F8B"})})]}),rules:constant/* REQUIRED_RULES */.f4,children:/*#__PURE__*/(0,jsx_runtime.jsx)(TextArea,{placeholder:"\u8BF7\u8F93\u5165\u6807\u51C6JSON\u683C\u5F0F",autoSize:{minRows:15,maxRows:15}})}),/*#__PURE__*/(0,jsx_runtime.jsx)(es_form/* default.Item */.Z.Item,{children:/*#__PURE__*/(0,jsx_runtime.jsxs)(space/* default */.Z,{size:"large",children:[/*#__PURE__*/(0,jsx_runtime.jsx)(es_button/* default */.Z,{type:"primary",htmlType:"submit",style:{width:120},children:"\u5BFC\u5165"}),/*#__PURE__*/(0,jsx_runtime.jsx)(es_button/* default */.Z,{htmlType:"reset",children:"\u91CD\u7F6E"})]})})]})});};/* harmony default export */ var components_ImportConfigModal = (ImportConfigModal);
;// CONCATENATED MODULE: ./src/page/SelectTestData/index.tsx
var INITIAL_DATA=[{key:"chen",value:"chen",label:"陈",title:"陈",children:[{key:"jiang",value:"jiang",title:"江",label:"江"}]},{key:"25",value:"25",title:"年龄",label:"年龄"}];var SelectTestData=function SelectTestData(props){var _useState=(0,react.useState)(""),_useState2=(0,slicedToArray/* default */.Z)(_useState,2),code=_useState2[0],setCode=_useState2[1];// 生成的代码
var _useState3=(0,react.useState)(INITIAL_DATA),_useState4=(0,slicedToArray/* default */.Z)(_useState3,2),treeData=_useState4[0],setTreeData=_useState4[1];var _useState5=(0,react.useState)(false),_useState6=(0,slicedToArray/* default */.Z)(_useState5,2),visible=_useState6[0],setVisible=_useState6[1];// 导入配置
/**
   * 导入配置弹窗关闭
   */var onCancel=function onCancel(){setVisible(false);};/* 
    根据导入的导入配置生成折叠面板(也就是表格的columns)
  */var importSubmit=function importSubmit(value){setTreeData((0,toConsumableArray/* default */.Z)(value));setVisible(false);};return/*#__PURE__*/(0,jsx_runtime.jsx)(jsx_runtime.Fragment,{children:/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:"select-test-data",children:[/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:"condition",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("h2",{className:"title",children:"\u6784\u5EFA\u914D\u7F6E"}),/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:"control",children:[/*#__PURE__*/(0,jsx_runtime.jsx)(es_button/* default */.Z,{onClick:function onClick(){setVisible(true);},children:"\u5BFC\u5165\u914D\u7F6E"}),/*#__PURE__*/(0,jsx_runtime.jsx)(es_button/* default */.Z,{type:"primary",onClick:function onClick(){setCode(JSON.stringify(treeData,function(key,value){if(typeof value==="boolean"||Array.isArray(value)&&!value.length){return undefined;}return value;},2));},children:"\u751F\u6210\u4EE3\u7801"})]}),/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:"container",children:[/*#__PURE__*/(0,jsx_runtime.jsx)(components_ImportConfigModal,{visible:visible,onCancel:onCancel,onSubmit:importSubmit}),/*#__PURE__*/(0,jsx_runtime.jsx)(components_DraggableTree,{data:treeData,onChange:function onChange(data){setTreeData((0,toConsumableArray/* default */.Z)(data));}})]})]}),/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:"code",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("h2",{className:"title",children:"\u6D4B\u8BD5\u6570\u636E"}),code?/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:"code-content",children:[/*#__PURE__*/(0,jsx_runtime.jsx)(es_button/* default */.Z,{icon:/*#__PURE__*/(0,jsx_runtime.jsx)(CopyOutlined/* default */.Z,{}),onClick:function onClick(){if(!code)return message/* default.info */.ZP.info("没有啥要复制的");copy_to_clipboard_default()(code);message/* default.success */.ZP.success("已复制到剪切板");},children:"\u590D\u5236"}),/*#__PURE__*/(0,jsx_runtime.jsx)(CodeEditor/* default */.Z,{value:code,language:"javascript"})]}):/*#__PURE__*/(0,jsx_runtime.jsx)(empty/* default */.Z,{description:"\u6682\u65E0\u6570\u636E"})]})]})});};/* harmony default export */ var page_SelectTestData = (SelectTestData);
