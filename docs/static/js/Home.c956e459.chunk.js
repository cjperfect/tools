...
/* harmony export */ });
/* 存放一些常量 */var REQUIRED_RULES=[{required:true,message:"请输入"}];var CONFIG_EXAMPLE=[{dataIndex:"name",title:"姓名",ellipsis:true,width:150,align:"left"},{dataIndex:"date",title:"日期",ellipsis:true,width:150,align:"left"}];/**
 * 默认添加的字段信息
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(47313);
/* harmony import */ var antd__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(17786);
/* harmony import */ var antd__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(98740);
...
/* harmony import */ var antd__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(94401);
/* harmony import */ var antd__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(98276);
/* harmony import */ var config_constant__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(54246);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(46417);
/* 查看已导入配置的抽屉 */var TextArea=antd__WEBPACK_IMPORTED_MODULE_3__/* ["default"].TextArea */ .Z.TextArea;var ConfigDrawer=function ConfigDrawer(props){var visible=props.visible,onClose=props.onClose,setContent=props.setContent;var _Form$useForm=antd__WEBPACK_IMPORTED_MODULE_4__/* ["default"].useForm */ .Z.useForm(),_Form$useForm2=(0,C_Users_Administrator_Desktop_study_generate_columns_node_modules_babel_runtime_helpers_esm_slicedToArray_js__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z)(_Form$useForm,1),form=_Form$useForm2[0];var _useState=(0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(0),_useState2=(0,C_Users_Administrator_Desktop_study_generate_columns_node_modules_babel_runtime_helpers_esm_slicedToArray_js__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z)(_useState,2),dispatch=_useState2[1];var configList=JSON.parse(localStorage.myConfig||"[]");(0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function(){if(visible){form.setFieldsValue({configList:configList});}// eslint-disable-next-line
},[visible]);return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(antd__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .Z,{title:"\u67E5\u770B\u5DF2\u5BFC\u5165\u7684\u914D\u7F6E",placement:"right",open:visible,size:"large",onClose:onClose,children:configList!==null&&configList!==void 0&&configList.length?/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(antd__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z,{form:form,layout:"vertical",initialValues:{configList:configList},children:/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(antd__WEBPACK_IMPORTED_MODULE_4__/* ["default"].List */ .Z.List,{name:"configList",children:function children(fields,_ref){var remove=_ref.remove;return fields.map(function(field,index){return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(antd__WEBPACK_IMPORTED_MODULE_4__/* ["default"].Item */ .Z.Item,{name:[field.name,"config"],rules:config_constant__WEBPACK_IMPORTED_MODULE_1__/* .REQUIRED_RULES */ .f4,label:/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.Fragment,{children:/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsxs)(antd__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .Z,{children:["\u7F16\u53F7",index+1,/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(antd__WEBPACK_IMPORTED_MODULE_8__/* ["default"] */ .Z,{danger:true,onClick:function onClick(){antd__WEBPACK_IMPORTED_MODULE_9__/* ["default"].confirm */ .Z.confirm({content:"确定要删除吗？",okText:"确认",cancelText:"取消",onOk:function onOk(){var current=form.getFieldValue("configList");current.splice(field.name,1);localStorage.myConfig=JSON.stringify(current);dispatch(Math.random());remove(field.name);}});},children:"\u5220\u9664"}),/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(antd__WEBPACK_IMPORTED_MODULE_8__/* ["default"] */ .Z,{onClick:function onClick(){setContent(configList[field.name].config);onClose();},children:"\u9009\u62E9"})]})}),children:/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(TextArea,{placeholder:"\u8BF7\u8F93\u5165\u914D\u7F6E",autoSize:{minRows:10,maxRows:10}})},field.key);});}})}):/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(antd__WEBPACK_IMPORTED_MODULE_10__/* ["default"] */ .Z,{description:"\u6682\u65E0\u6570\u636E"})},"right");};/* harmony default export */ __webpack_exports__["Z"] = (ConfigDrawer);
...
temp[dataIndex]=random[randomType](0,100,2,2);}else{temp[dataIndex]=random[randomType]();}});data.push(temp);};for(var i=1;i<=num;i++){_loop(i);}return{data:data,columns:columns,dataText:"const dataSource = ".concat(JSON.stringify(data,null,2)),columnsText:"const ".concat(variable," = ").concat(JSON.stringify(newColumns,null,2))};};
